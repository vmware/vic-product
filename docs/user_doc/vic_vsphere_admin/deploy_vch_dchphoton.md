...
* Obtain the root certificate for vSphere Integrated Containers Registry. For information about how to obtain the certificate, see [Download the vSphere Integrated Containers Registry Certificate](../vic_cloud_admin/download_reg_cert_admin.md) in *vSphere Integrated Containers Management Portal Administration*.
