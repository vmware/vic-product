...
- If you installed a version of vSphere Integrated Containers that pre-dates 1.4.3, see [Manually Install the vSphere Client Plug-ins](install_vic_plugin.md).
