...
This example uses vSphere Integrated Containers Engine 1.1.0, Harbor 0.5.0, and Ubuntu on the user machine. Harbor requires 60GB or more free space on your datastore.
