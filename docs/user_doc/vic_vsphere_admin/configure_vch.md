...
This example sets the `--debug` option to 0, to disable debug mode on a VCH that is already running at any level of debug mode. By default, VCHs run with debugging level 1.
