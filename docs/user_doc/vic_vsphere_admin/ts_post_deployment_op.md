# Troubleshoot Post-Deployment Operation #

This section provides solutions for common problems that you might encounter when using vSphere Integrated Containers Management Portal or virtual container hosts (VCHs) after deployment.
