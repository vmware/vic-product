 ...
 * [Installation](installing_vic.md)
     ...
     * [Manually Install Plug-in](install_vic_plugin.md)
  ...
  * [Upgrading](upgrading_vic.md)
     ...
     * [Manually Upgrade Plug-In](upgrade_plugins.md)
         * [vCenter Server for Windows](upgrade_h5_plugin_windows.md)
         * [vCenter Server Appliance](upgrade_h5_plugin_vcsa.md)
