...
**IMPORTANT**: `vic-machine` supports the use of PEM/DER/ASN.1 encoded single certificates. PKCS#7 certificates do not work with `vic-machine`. For information about how to convert PKCS#7 certificates, see [vSphere Integrated Containers Certificate Reference](vic_cert_reference.md#convertcerts). 
