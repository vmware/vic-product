...
1. Log in to vSphere Integrated Containers Mangagement Portal at http://vic_appliance_address and following the **Go to the vSphere Integrated Containers Management Portal** link.
