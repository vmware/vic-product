 ...
 * [Installation](vic_vsphere_admin/installing_vic.md)
  ...
  * [Deploy VCHs with `vic-machine`](vic_vsphere_admin/deploy_vch.md)
     ...
     * [VCH Networking](vic_vsphere_admin/vch_networking.md)
         ...
         * [Specify a Static IP Address for the VCH Endpoint VM](vic_vsphere_admin/vch_static_ip.md)
         * [Configure VCHs to Use Proxy Servers](vic_vsphere_admin/vch_proxy.md)
