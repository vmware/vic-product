...
docker run --net grid --rm -v $PWD/vic-product:/go --env-file vic-internal/vic-product-nightly-secrets.list gcr.io/eminent-nation-87317/vic-integration-test:1.46 pabot --processes 4 --removekeywords TAG:secret --exclude skip tests/manual-test-cases/Group5-Interoperability-Tests/5-15-NFS-Datastore.robot
