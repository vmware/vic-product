...
*** Settings ***
Documentation  Test 8-11 - Manual Upgrade 1.5.5
...
*** Test Cases ***
Upgrade from v1.5.5
    ${old-ova-file-name}=        Set Variable  vic-v1.5.5-7767-a7161963.ova
    ${old-ova-version}=          Set Variable  v1.5.5
    ${old-appliance-name}=       Set Variable  manual-upgrade-${old-ova-file-name}
    ${new-appliance-name}=       Set Variable  manual-upgrade-from-1.5.5-LATEST
