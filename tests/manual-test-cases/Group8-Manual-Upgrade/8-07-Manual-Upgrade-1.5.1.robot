...
*** Settings ***
Documentation  Test 8-07 - Manual Upgrade 1.5.1
...
*** Test Cases ***
Upgrade from v1.5.1
    ${old-ova-file-name}=        Set Variable  vic-v1.5.1-6995-a6158aac.ova
    ${old-ova-version}=          Set Variable  v1.5.1
    ${old-appliance-name}=       Set Variable  manual-upgrade-${old-ova-file-name}
    ${new-appliance-name}=       Set Variable  manual-upgrade-from-1.5.1-LATEST
