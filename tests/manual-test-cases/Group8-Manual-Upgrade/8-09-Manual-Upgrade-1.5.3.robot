...
*** Settings ***
Documentation  Test 8-09 - Manual Upgrade 1.5.3
...
*** Test Cases ***
Upgrade from v1.5.3
    ${old-ova-file-name}=        Set Variable  vic-v1.5.3-7511-ba6b1644.ova
    ${old-ova-version}=          Set Variable  v1.5.3
    ${old-appliance-name}=       Set Variable  manual-upgrade-${old-ova-file-name}
    ${new-appliance-name}=       Set Variable  manual-upgrade-from-1.5.3-LATEST
