...
*** Settings ***
Documentation  Test 8-10 - Manual Upgrade 1.5.4
...
*** Test Cases ***
Upgrade from v1.5.4
    ${old-ova-file-name}=        Set Variable  vic-v1.5.4-7589-e70af4fe.ova
    ${old-ova-version}=          Set Variable  v1.5.4
    ${old-appliance-name}=       Set Variable  manual-upgrade-${old-ova-file-name}
    ${new-appliance-name}=       Set Variable  manual-upgrade-from-1.5.4-LATEST
