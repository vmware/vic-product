...
*** Settings ***
Documentation  Test 8-08 - Manual Upgrade 1.5.2
...
*** Test Cases ***
Upgrade from v1.5.2
    ${old-ova-file-name}=        Set Variable  vic-v1.5.2-7206-92ebfaf5.ova
    ${old-ova-version}=          Set Variable  v1.5.2
    ${old-appliance-name}=       Set Variable  manual-upgrade-${old-ova-file-name}
    ${new-appliance-name}=       Set Variable  manual-upgrade-from-1.5.2-LATEST
