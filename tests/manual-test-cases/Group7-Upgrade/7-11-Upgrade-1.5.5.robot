...
*** Settings ***
Documentation  Test 7-11 - Upgrade 1.5.5
...
*** Variables ***
${old-ova-file-name}=  vic-v1.5.5-7767-a7161963.ova
${old-ova-version}=  v1.5.5
...
*** Test Cases ***
Upgrade OVA 1.5.5
    Auto Upgrade OVA With Verification  7-11-UPGRADE-1-5-5  ${old-ova-file-name}  ${old-ova-version}  ${old-ova-cert-path}  ${new-ova-cert-path}  dc1
