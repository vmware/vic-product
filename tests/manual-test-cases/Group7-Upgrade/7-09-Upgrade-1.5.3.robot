...
*** Settings ***
Documentation  Test 7-09 - Upgrade 1.5.3
...
*** Variables ***
${old-ova-file-name}=  vic-v1.5.3-7511-ba6b1644.ova
${old-ova-version}=  v1.5.3
...
*** Test Cases ***
Upgrade OVA 1.5.3
    Auto Upgrade OVA With Verification  7-09-UPGRADE-1-5-3  ${old-ova-file-name}  ${old-ova-version}  ${old-ova-cert-path}  ${new-ova-cert-path}  dc1
