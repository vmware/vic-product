...
*** Settings ***
Documentation  Test 7-10 - Upgrade 1.5.4
...
*** Variables ***
${old-ova-file-name}=  vic-v1.5.4-7589-e70af4fe.ova
${old-ova-version}=  v1.5.4
...
*** Test Cases ***
Upgrade OVA 1.5.4
    Auto Upgrade OVA With Verification  7-10-UPGRADE-1-5-4  ${old-ova-file-name}  ${old-ova-version}  ${old-ova-cert-path}  ${new-ova-cert-path}  dc1
