...
*** Settings ***
Documentation  Test 7-07 - Upgrade 1.5.1
...
*** Variables ***
${old-ova-file-name}=  vic-v1.5.1-6995-a6158aac.ova
${old-ova-version}=  v1.5.1
...
*** Test Cases ***
Upgrade OVA 1.5.1
    Auto Upgrade OVA With Verification  7-07-UPGRADE-1-5-1  ${old-ova-file-name}  ${old-ova-version}  ${old-ova-cert-path}  ${new-ova-cert-path}  dc1
    Stop All Containers
