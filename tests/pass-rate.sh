...
echo "Current vmware/vic-product CI passrate: $passrate"
curl --max-time 10 --retry 3 -s -d "payload={'channel': '#vic-bots', 'text': 'Current vmware/vic-product CI passrate: $passrate%'}" "$SLACK_URL"
